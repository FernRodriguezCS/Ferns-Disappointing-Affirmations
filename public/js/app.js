const affirmations = {
  ...
  11: "You’re doing the best that you can. Which is pretty sad", // keep one 11
...
btn.addEventListener('click', () => {
  const aff = document.getElementById('output');
  aff.textContent = affirmations[getRandomInt(1, 30)];
});

if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker
      .register('/service-worker.js') // moved to root
